...
public class AlumnoapoderadoJpaController implements Serializable {
    ...
    public List<Alumnoapoderado> listarxalumno(int idalumno) {

        List<Alumnoapoderado> lista = null;
        try {
            em.getTransaction().begin();
            Query q = em.createQuery("select a from Alumnoapoderado a where a.idalumno.id =:alumno ", Alumnoapoderado.class);
