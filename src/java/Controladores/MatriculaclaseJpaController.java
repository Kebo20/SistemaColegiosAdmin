...
public class MatriculaclaseJpaController implements Serializable {
 private static EntityManagerFactory emf;
    ...
    public List<Matriculaclase> listarxmatricula(int idmatricula) {

        List<Matriculaclase> lista = null;
        try {
            em.getTransaction().begin();
            Query q = em.createQuery("select m from Matriculaclase m where m.idmatricula.id = :matricula ",Matriculaclase.class);
    ...
    public void create(Matriculaclase matriculaclase) {
