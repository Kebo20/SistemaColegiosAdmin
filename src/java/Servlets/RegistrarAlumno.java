...
//        request.setCharacterEncoding("UTF-8");
        try (PrintWriter out = response.getWriter()) {
            ...
            p.setCodminedu(request.getAttribute("codmineduRP").toString());
            ...
            p.setEstado(request.getAttribute("estadoRP").toString());
            ...
            p.setDiscapacidad(request.getAttribute("discapacidadRP").toString());
            p.setDepartamento(request.getAttribute("departamentoRP").toString());
            p.setDistrito(request.getAttribute("distritoRP").toString());
            p.setProvincia(request.getAttribute("provinciaRP").toString());
            p.setColegioanterior(request.getAttribute("colegioRP").toString());
            p.setLenguas(request.getAttribute("lenguasRP").toString());
