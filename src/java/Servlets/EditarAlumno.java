...
//        request.setCharacterEncoding("UTF-8");
        try (PrintWriter out = response.getWriter()) {
            ...
            AlumnoJpaController pc = new AlumnoJpaController();
            Alumno p = new Alumno();
            ...
            p.setContraseña(request.getAttribute("contraseñaEP").toString());
            ...
            p.setDiscapacidad(request.getAttribute("discapacidadEP").toString());
            p.setDepartamento(request.getAttribute("departamentoEP").toString());
            p.setDistrito(request.getAttribute("distritoEP").toString());
            p.setProvincia(request.getAttribute("provinciaEP").toString());
            p.setColegioanterior(request.getAttribute("colegioEP").toString());
            p.setLenguas(request.getAttribute("lenguasEP").toString());
            p.setEstado(request.getAttribute("estadoEP").toString());
            p.setCodminedu(request.getAttribute("codmineduEP").toString());

            String ruta = request.getServletContext().getRealPath("/") + "archivos/";
//String ruta = "/opt/tomcat/webapps/archivos-colegios/fotos-alumno/";
