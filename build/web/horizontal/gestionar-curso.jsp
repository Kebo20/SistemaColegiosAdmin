...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border logo-center">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Gestionar Curso</li>
                            </ol>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <button  data-toggle="modal" data-target="#ModalRC" class="btn btn-dropbox" >Añadir</button>

                                    <h6 class="card-subtitle"></h6>
                                    <div class="table-responsive m-t-40">
                                        <table id="tableCurso" class="display nowrap table table-hover table-striped table-bordered text-center text-dark" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Curso</th>
                                                    <th>Descripción</th>
        ...
        <script >
            $(document).on('submit', '#formRcurso', function () {
                $.ajax({
                    type: 'POST',
                    url: '../RegistrarCurso',
                    data: {
                        nombre: $("#nombreRC").val(),
                        descripcion: $("#descripcionRC").val(),
                        idarea: $("#idareaRC").val(),
                        idgrado: $("#idgradoRC").val()
                    },
            ...
            $(document).on('submit', '#formEcurso', function () {
                $.ajax({
                    type: 'POST',
                    url: '../EditarCurso',
                    data: {
            ...
            $(document).on('submit', '#formELcurso', function () {
                $.ajax({
                    type: 'POST',
                    url: '../EliminarCurso',
                    data: {
            ...
            function editarCurso(id, nombre, descripcion, idarea,idgrado) {
                    ...
                    <form id="formRcurso">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nombreRC" required />
                            </div>

                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Descripción</label>
                                <input type="text" class="form-control" id="descripcionRC"  />
                            </div>

                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Area</label>
                                <%
                                    AreaJpaController ac = new AreaJpaController();
                                %>
                                <select id="idareaRC" class="select2" style="width: 100%"  required="">
                                    <option value="">Selecciona un área</option>


                                    <% for (Area area : ac.findAreaEntities()) {%>
                            ...
                            <div class="form-group">
                                ...
                                %>
                                <select id="idgradoRC" class="select2" style="width: 100%"  required="">
                ...
                <div class="modal-content">
                    ...
                    <form id="formEcurso">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Nombre</label>
                                <input type="text" class="form-control" id="nombreEC" required />
                                <input  class="form-control" id="idEC" type="hidden" />
                            </div>

                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Descripción</label>
                                <input type="text" class="form-control" id="descripcionEC"  />
                            </div>

                                   <div class="form-group">
                                <label for="recipient-name" class="control-label">Area</label>
                                <%
                                    AreaJpaController ac1 = new AreaJpaController();
                                %>
                                <select id="idareaEC" class="select2" style="width: 100%"  required="">
                                    <option value="">Selecciona un área</option>


                                    <% for (Area area : ac1.findAreaEntities()) {%>
                              ...
                              <div class="form-group">
                                <label for="recipient-name" class="control-label">Grado</label>
                                    <% 
                                        GradoJpaController gn1 = new GradoJpaController();
                                    %>
                                <select id="idgradoEC" class="select2" style="width: 100%"  required="">
                                    <option value="">Selecciona un grado</option>
                                    
                                 
                                    <% for (Grado grado : gn1.findGradoEntities() ){%>
                ...
                <div class="modal-content">
                    ...
                    <form id="formELcurso">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label text-dark">¿Está seguro de eliminar este curso?</label>
