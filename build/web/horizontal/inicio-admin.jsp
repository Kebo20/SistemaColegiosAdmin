                ...
                <nav class="navbar top-navbar navbar-expand-md navbar-light">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="index.html">
                            ...
                            <!-- Logo icon -->
                            <b>
                                <h3 class="text-white">xxxxxxx - I.E SAN MARTIN DE PORRES</h3> 
                            ...
                            <span>
                                ...
                                <!-- Light Logo text -->    
                                <!--<img src="../assets/images/logo-light-text.png..." class="light-logo" alt="EDU - I.E SAN MARTIN" /-->
                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li>
                                <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Alumnos</span></a>
                                <ul aria-expanded="false" class="collapse">
                            ...
                            <li class="three-column">
                                <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Profesores</span></a>
                                <ul aria-expanded="false" class="collapse">
                            ...
                            <li class="two-column">
                                <a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Cursos</span></a>
                                <ul aria-expanded="false" class="collapse">
                            ...
                            <li>
                                <a class="has-arrow " href="#" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Usuarios</span></a>
                                <ul aria-expanded="false" class="collapse">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row text-center">
                                        <div class="col-lg-4 col-md-4 m-t-20">
                                            <h1 class="m-b-0 font-light">58</h1><small>Total Sent</small></div>
                                        <div class="col-lg-4 col-md-4 m-t-20">
                                            <h1 class="m-b-0 font-light">46</h1><small>Mail Open Rate</small></div>
                                        <div class="col-lg-4 col-md-4 m-t-20">
                                            <h1 class="m-b-0 font-light">13</h1><small>Click Rate</small></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Registrar año escolar</h4>
                                    <h6 class="card-subtitle">--------------------------------</h6>             
                                    <form id="formRano" >
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-2 col-form-label">Descripción</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="descripcion" id="descripcionRA">
                                        </div>
                                    </div>
