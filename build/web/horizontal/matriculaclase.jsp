                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li>
                                <a class="has-arrow " href="gestionar-apoderado.jsp" aria-expanded="false"><i capoderadoslass="fa fa-users"></i><span class="hide-menu">Apoderados</span></a>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" id="matricula" value="<%=request.getParameter("matricula")%>">
                                    <h6 class="card-subtitle"></h6>
                                    <div class="table-responsive m-t-40">
                                        <table id="tableMatriculaclase" class="display nowrap table table-hover table-striped table-bordered text-center text-dark" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Clase</th>
                                                    <th>Profesor</th>
            ...
            $(document).on('submit', '#formELmatricula', function () {
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#tableMatriculaclase').DataTable().ajax.reload();
                    }
                });
                return false;
            });
            function eliminarMatriculaclase(id) {
