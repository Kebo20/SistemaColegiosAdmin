                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Gestionar Grado</li>
                            </ol>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <button  data-toggle="modal" data-target="#ModalRG" class="btn btn-dropbox" >Añadir</button>

                                    <h6 class="card-subtitle"></h6>
                                    <div class="table-responsive m-t-40">
                                        <table id="tableGrado" class="display nowrap table table-hover table-striped table-bordered text-center text-dark" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Nombre</th>
                                                    <th>Nivel</th>
            ...
            $(document).on('submit', '#formRgrado', function () {
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#tableGrado').DataTable().ajax.reload();
                        $('#ModalRG').modal("hide");
                    }
                });
                return false;
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Registrar grado</h4>
                    </div>
                    <form id="formRgrado">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Nivel</label>
                                    <% 
                                        NivelJpaController n = new NivelJpaController(Persistence.createEntityManagerFactory("colegiosPU"));
                                    %>
                                <select id="idRG" class="select2" style="width: 100%"  required="">    
                                    <option value="">Selecciona un Nivel</option>
                                    <% for (Nivel nivel : n.findNivelEntities() ){%>
                                    
                                    
                                    <option value="<%=nivel.getId()%>"><%=nivel.getTipo() %></option>
                                    <%}%>
                                </select>
                            </div>
                    ...
                    <form id="formEgrado">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="idEG" type="hidden" />
                            </div>

                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Nivel</label>
                                    <% 
                                        NivelJpaController ne = new NivelJpaController(Persistence.createEntityManagerFactory("colegiosPU"));
                                    %>
                                <select id="idnivelEG" class="select2" style="width: 100%"  required="">
                                    <option value="">Selecciona un nivel</option>
                                    
                                 
                                    <% for (Nivel nivel : ne.findNivelEntities() ){%>
                ...
                <div class="modal-content">
                    ...
                    <form id="formELgrado">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label text-dark">¿Está seguro de eliminar este grado?</label>
