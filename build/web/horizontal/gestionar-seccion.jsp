...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border logo-center">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Gestionar Sección</li>
                            </ol>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <button  data-toggle="modal" data-target="#ModalRS" class="btn btn-dropbox" >Añadir</button>

                                    <h6 class="card-subtitle"></h6>
                                    <div class="table-responsive m-t-40">
                                        <table id="tableSeccion" class="display nowrap table table-hover table-striped table-bordered text-center text-dark" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Sección</th>
                                                    <th>Grado</th>
        ...
        <script >
            $(document).on('submit', '#formRseccion', function () {
                $.ajax({
                    type: 'POST',
                    url: '../RegistrarSeccion',
                    data: {
                        nombre: $("#nombreRS").val(),
                        idgrado: $("#idRS").val()
                    },
                    success: function (result) {
                        ...
                        $('#tableSeccion').DataTable().ajax.reload();
                        $('#ModalRS').modal("hide");
                    }
                });
                return false;
            ...
            $(document).on('submit', '#formEseccion', function () {
                $.ajax({
                    type: 'POST',
                    url: '../EditarSeccion',
                    data: {     
            ...
            $(document).on('submit', '#formELseccion', function () {
                $.ajax({
                    type: 'POST',
                    url: '../EliminarSeccion',
                    data: {
            ...
            function editarSeccion(id, nombre, idgrado) {

                $("#ModalES").modal("show");
                $("#idES").val(id);
                $("#nombreES").val(nombre);
                $("#idgradoES").val(idgrado);
                $("#idgradoES").change();
        ...
        <div id="ModalRS" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="formRseccion">
                        <div class="modal-body">

                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Nombre</label>
                                <input type="text" class="form-control" id="nombreRS" required />
                            </div>
                            
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Grado</label>
                                    <% 
                                        GradoJpaController g = new GradoJpaController();
                                    %>
                                <select id="idRS" class="select2" style="width: 100%"  required="">    
                                    <option value="">Selecciona un Nivel</option>
                                    <% for (Grado grado : g.findGradoEntities() ){%>
        ...
        <!-- sample modal content -->
        <div id="ModalES" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <form id="formEseccion">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Nombre</label>
                                <input type="text" class="form-control" id="nombreES" required />
                                <input  class="form-control" id="idES" type="hidden" />
                            </div>

                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Grado</label>
                                    <% 
                                        GradoJpaController gn = new GradoJpaController();
                                    %>
                                <select id="idgradoES" class="select2" style="width: 100%"  required="">
                                    <option value="">Selecciona un grado</option>
                                    
                                 
                                    <% for (Grado grado : gn.findGradoEntities() ){%>
        ...
        <!-- /.modal -->
        <!-- sample modal content -->
        <div id="ModalELS" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <form id="formELseccion">
                        <div class="modal-body">

                            <div class="form-group">
                                <label for="recipient-name" class="control-label text-dark">¿Está seguro de eliminar esta sección?</label>

                                <input  class="form-control" id="idELS" type="hidden" />
                            </div>
