...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border logo-center">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive m-t-40">
                                        <table id="tablePeriodo" class="display nowrap table table-hover table-striped table-bordered text-center text-dark" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Descripción</th>
        ...
        <!-- Registrar -->
        <div id="ModalRP" class="modal fade"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    ...
                    <form id="formRP">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="descripcionRP" required />
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Fecha inicio</label>
                                <input type="date" class="form-control" id="fecha_inicioRP" required />
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Fecha final</label>
                                <input type="date" class="form-control" id="fecha_finRP" required />
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Año escolar</label>
                                <% AnoJpaController a = new AnoJpaController(); %>
                                <select id="añoRP" class="select2 " style="width: 100%; "required> 
                                    <option value="">Selecciona un año escolar</option>

                                    <%for (Ano año : a.findAnoEntities()) {%>
                                    <option value="<%=año.getId()%>"><%=año.getDescripcion()%></option>
                                    <% }%>
                                </select>
                            </div>
        ...
        <!-- Editar-->
        <div id="ModalEP" class="modal fade"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <form id="formEP">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Descripción</label>
                                <input type="text" class="form-control" id="descripcionEP" required />
                                <input class="form-control" id="idEP" type="hidden" />
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Fecha inicio</label>
                                <input type="date" class="form-control" id="fecha_inicioEP" required />
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Fecha final</label>
                                <input type="date" class="form-control" id="fecha_finEP" required />
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Año escolar</label>
                                <% AnoJpaController a1 = new AnoJpaController(); %>
                                <select id="añoEP" class="select1 " style="width: 100%; " required> 
                                    <option value="">Selecciona un año escolar</option>

                                    <%for (Ano año : a1.findAnoEntities()) {%>
                                    <option value="<%=año.getId()%>"><%=año.getDescripcion()%></option>
                                    <% }%>
                                </select>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="formELP">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label text-dark">¿Está seguro de eliminar este periódo escolar?</label>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $(".select1").select2({
                dropdownParent: $('#ModalEP')
            });
                $(".select2").select2({
                dropdownParent: $('#ModalRP')
            });
            });
        </script>
