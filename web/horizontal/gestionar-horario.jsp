                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <button  data-toggle="modal" data-target="#ModalRH" class="btn btn-dropbox" >Añadir</button>
                ...
                <div class="modal-content">
                    ...
                    <form id="formELhorario">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label text-dark">¿Está seguro de eliminar este horario?</label>
