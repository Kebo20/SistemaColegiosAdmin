...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border logo-center">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Gestionar año académico</li>
                            </ol>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Lista de Años Escolares</h4>

                                    <button  data-toggle="modal" data-target="#ModalRA" class="btn btn-dropbox" >Añadir</button>

                                    <h6 class="card-subtitle"></h6>
                                    <div class="table-responsive m-t-40">
                                        <table id="tableAño" class="display nowrap table table-hover table-striped table-bordered text-center text-dark" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Descripción</th>
                                                    <th></th>
        ...
        <script>
            $(document).on('submit', '#formRano', function () {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        $('#tableAño').DataTable().ajax.reload();
                        $('#ModalRA').modal("hide");
            ...
            $(document).on('submit', '#formEano', function () {
            ...
            $(document).on('submit', '#formELano', function () {
            ...
            function editarAño(id, descripcion) {
        ...
        <div id="ModalRA" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title">Registrar año escolar</h4>
                    </div>
                    <form id="formRano">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="descripcionRA" required />
                            </div>
        ...
        <!-- sample modal content -->
        <div id="ModalEA" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title">Editar año escolar</h4>
                    </div>
                    <form id="formEano">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Descripción</label>
                                <input type="text" class="form-control" id="descripcionEA" required />
                ...
                <div class="modal-content">
                    ...
                    <form id="formELano">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label text-dark">¿Está seguro de eliminar este año escolar?</label>
