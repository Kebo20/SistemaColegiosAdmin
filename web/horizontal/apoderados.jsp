    ...
    <body class="fix-header card-no-border logo-center">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Lista de Apoderados de  <%= request.getParameter("nombre")%> </h4>

                                    <button  data-toggle="modal" data-target="#ModalRA" style="position: absolute;top: 3%;right: 1%" class="btn btn-dropbox" >Añadir</button>
                                    <input type="hidden" id="alumno" value="<%=request.getParameter("alumno")%>">
        ...
        <script >
            ...
            $('#tableApoderado').DataTable({
                ...
                ajax: {
                    url: "../ListarApoderadoAlumno?id=" + $("#alumno").val(),
                    method: "post",
                    dataSrc: "datos"
            ...
            $(document).on('submit', '#formRA', function () {
                $.ajax({
                    type: 'POST',
                    url: '../RegistrarAlumnoapoderado',
                    data: {
                        alumno: $("#alumno").val(),
                        apoderado: $("#idapoderado").val()
                    ...
                    success: function (result) {
                        if (result == ":)") {
                            ...
                            swal("Error", "Apoderado ya registrado", "error");
                        }
        ...
        <div id="ModalRA" class="modal fade" name='modal' role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    ...
                    <form id="formRA">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Apoderado</label>
                                <select id="idapoderado" class="select2" style="width: 100%"  required="">
                                    <%
                                        ApoderadoJpaController an = new ApoderadoJpaController();
                                    %>
                                    <option value="">Selecciona un apoderado</option>
                                    <% for (Apoderado apoderado : an.findApoderadoEntities()) {%>
                                    <option value="<%=apoderado.getId()%>"><%=apoderado.getNombre() + " " + apoderado.getContraseña() + " " + apoderado.getApMaterno()%></option>
                                    <%}%>
                                </select> 
                            </div>
