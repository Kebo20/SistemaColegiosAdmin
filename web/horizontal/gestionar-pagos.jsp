...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border logo-center">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive m-t-40">
                                        <table id="tablePago" class="display nowrap table table-hover table-striped table-bordered text-left text-dark" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
        ...
        <script>
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                ...
                                if (result == ":)") {
                                    ...
                                    swal("Incorrecto", result, "error");

                                }


                                $('#tablePago').DataTable().ajax.reload();
            ...
            function editarPago(id, comprobante, fecha, alumno) {

                $("#alumnoEP").val(alumno);
                $("#alumnoEP").change();

                $("#comprobanteEP").val(comprobante);
                $("#idEP").val(id);
                $("#fechaEP").val(fecha);
                    ...
                    <form id="formELP">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label text-dark">¿Está seguro de eliminar este pago?</label>
