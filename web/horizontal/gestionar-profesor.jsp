...
<html lang="en">
    ...
    <body class="fix-header fix-sidebar card-no-border logo-center">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 col-8 align-self-center">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Gestionar Profesores</li>
                            </ol>
                        </div>
                                    ...
                                    <form id="formRP"  class=" wizard-circle" enctype="multipart/form-data">
                                        ...
                                        <section>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="emailAddress1">Grado Académico:</label>
                                                        <span><icon class="fa fa-asterisk"></icon></span>
                                                        <input type="text" class="form-control" id="gradoRP" name="gradoRP" required> </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="emailAddress1">Descripción:</label>
                                                        <span><icon class="fa fa-asterisk"></icon></span>
                                                        <input type="text" class="form-control" id="descripcionRP" name="descripcionRP" required> </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <span><icon class="fa fa-asterisk"></icon></span>
                                                        <input type="file"  id="fotoRP" name="fotoRP" class="dropify" data-allowed-file-extensions = "pdf png jpg"  required>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body wizard-content">
                                    ...
                                    <form id="formEP" class=" wizard-circle">
                                        <!-- Step 1 -->
                                        <h6>Información personal</h6>
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="firstName1">DNI:</label>
                                                        <span><icon class="fa fa-asterisk"></icon></span>
                                                        <input type="text" maxlength="8" class="form-control" id="dniEP" name="dniEP" required> 
                                                        <input type="hidden"  id="idEP" name="idEP" required> 
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                        ...
                                        <section>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="phoneNumber1">Teléfono:</label>
                                                        <input type="tel" class="form-control" id="telefonoEP" name="telefonoEP"> </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="phoneNumber1">Dirección:</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="emailAddress1">Grado Académico</label>
                                                        <span><icon class="fa fa-asterisk"></icon></span>
                                                        <input type="text" class="form-control" id="gradoEP" name="gradoEP" required> </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="emailAddress1">Descripción</label>
                                                        <span><icon class="fa fa-asterisk"></icon></span>
                                                        <input type="text" class="form-control" id="descripcionEP" name="descripcionEP" required> </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="participants1">Contraseña</label>
                                                        <span><icon class="fa fa-asterisk"></icon></span>
                                                        <input type="text" class="form-control" id="contraseñaEP" name="contrasenaEP" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group ">
                                                        <label for="participants1">Foto</label>
                                                        <input type="file"  id="fotoEP" name="fotoEP" class="dropify" data-allowed-file-extensions = "pdf png psd jpg"  >
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group ">
        ...
        <script>
                                        ...
                                        ;
                                        function editarProfesor(id, nombre, paterno, materno, contraseña, correo, descripcion, direccion, dni, grado, sexo, telefono, usuario, nacimiento, foto) {
                ...
                <div class="modal-content">
                    ...
                    <form id="formELP">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label text-dark">¿Está seguro de eliminar este profesor?</label>
